<?php
/**
 * AttachmentBehavior::isSuccessfulWrite()のテスト
 *
 ...
 */
class AttachmentBehaviorIsSuccessfulWriteTest extends NetCommonsModelTestCase {
...
/**
 * isSuccessfulWrite()テストのDataProvider
 *
 * ### 戻り値
 ...
 * @return void
 */
	public function testIsSuccessfulWrite($check, $requireUpload) {
		//テスト実施
		$result = $this->TestModel->isSuccessfulWrite($check, $requireUpload);
