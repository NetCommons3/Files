<?php
/**
 * AttachmentBehavior::isWritable()のテスト
 *
 ...
 */
class AttachmentBehaviorIsWritableTest extends NetCommonsModelTestCase {
 ...
 * @return void
 */
	public function testIsWritable($check, $requireUpload) {
		//テスト実施
		$result = $this->TestModel->isWritable($check, $requireUpload);
